          ...
          headerActions={
            <>
              ...
              {isMe ? (
                <Link
                  href="/profile"
                  className="inline-flex shrink-0 items-center gap-2.5 rounded-xl border border-[var(--al-border)] bg-white/90 py-2 pl-2 pr-4 text-sm font-semibold text-[var(--al-ink)] shadow-sm transition hover:border-[color-mix(in_srgb,var(--al-accent)_40%,var(--al-border))] hover:bg-[var(--al-accent-soft)] active:scale-[0.98]"
                >
                  <span
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[var(--al-accent-soft)] text-[var(--al-accent)]"
                    aria-hidden
                  >
